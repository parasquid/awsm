...
| 5. Vault lifecycle           | Vault tests failed before the device slot, verifier authentication, locked-state persistence, and atomic creation existed.                                                                                                                                                                                                         | `tests/unit/vault.test.ts` passed create, auto-unlock, locked-state, corrupt-slot, verifier, and onboarding rollback cases; the real-browser `vault` integration scenario proved the stored AES-KW device key is non-exportable.                                                                                                                           |
